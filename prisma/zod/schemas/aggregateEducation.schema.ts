...
export const EducationAggregateSchema = z.object({
  orderBy: z
    .union([
  ...
  _count: z
    .union([z.literal(true), EducationCountAggregateInputObjectSchema])
    .optional(),
  _min: EducationMinAggregateInputObjectSchema.optional(),
  _max: EducationMaxAggregateInputObjectSchema.optional(),
  _avg: EducationAvgAggregateInputObjectSchema.optional(),
  _sum: EducationSumAggregateInputObjectSchema.optional(),
});
