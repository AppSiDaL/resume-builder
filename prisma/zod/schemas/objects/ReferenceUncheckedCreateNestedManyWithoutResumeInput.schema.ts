...
const Schema: z.ZodType<Prisma.ReferenceUncheckedCreateNestedManyWithoutResumeInput> =
  z
    .object({
      create: z
        .union([
...
export const ReferenceUncheckedCreateNestedManyWithoutResumeInputObjectSchema =
  Schema;
