...
import { ResumeUpdateOneRequiredWithoutExperiencesNestedInputObjectSchema } from './ResumeUpdateOneRequiredWithoutExperiencesNestedInput.schema';
...
const Schema: z.ZodType<Prisma.ExperienceUpdateInput> = z
  .object({
    ...
    resume: z
      .lazy(
        () => ResumeUpdateOneRequiredWithoutExperiencesNestedInputObjectSchema,
      )
      .optional(),
  })
  .strict();
