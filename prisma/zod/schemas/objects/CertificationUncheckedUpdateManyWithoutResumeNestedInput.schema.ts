...
const Schema: z.ZodType<Prisma.CertificationUncheckedUpdateManyWithoutResumeNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const CertificationUncheckedUpdateManyWithoutResumeNestedInputObjectSchema =
  Schema;
