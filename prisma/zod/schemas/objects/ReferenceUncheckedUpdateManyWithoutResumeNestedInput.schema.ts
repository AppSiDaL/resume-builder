...
const Schema: z.ZodType<Prisma.ReferenceUncheckedUpdateManyWithoutResumeNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ReferenceUncheckedUpdateManyWithoutResumeNestedInputObjectSchema =
  Schema;
