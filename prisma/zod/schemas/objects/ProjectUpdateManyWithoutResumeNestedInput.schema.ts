...
const Schema: z.ZodType<Prisma.ProjectUpdateManyWithoutResumeNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => ProjectUpdateManyWithWhereWithoutResumeInputObjectSchema),
        z
          .lazy(() => ProjectUpdateManyWithWhereWithoutResumeInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const ProjectUpdateManyWithoutResumeNestedInputObjectSchema = Schema;
