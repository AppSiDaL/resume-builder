...
const Schema: z.ZodType<Prisma.ResumeUncheckedCreateWithoutReferencesInput> = z
  .object({
...
export const ResumeUncheckedCreateWithoutReferencesInputObjectSchema = Schema;
