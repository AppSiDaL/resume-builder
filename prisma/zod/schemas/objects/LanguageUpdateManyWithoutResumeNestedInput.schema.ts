...
const Schema: z.ZodType<Prisma.LanguageUpdateManyWithoutResumeNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => LanguageUpdateManyWithWhereWithoutResumeInputObjectSchema),
        z
          .lazy(() => LanguageUpdateManyWithWhereWithoutResumeInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const LanguageUpdateManyWithoutResumeNestedInputObjectSchema = Schema;
