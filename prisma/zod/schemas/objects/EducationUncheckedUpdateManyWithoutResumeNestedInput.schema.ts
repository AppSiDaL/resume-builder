...
const Schema: z.ZodType<Prisma.EducationUncheckedUpdateManyWithoutResumeNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const EducationUncheckedUpdateManyWithoutResumeNestedInputObjectSchema =
  Schema;
