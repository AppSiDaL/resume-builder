...
const Schema: z.ZodType<Prisma.ResumeUncheckedUpdateWithoutExperiencesInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const ResumeUncheckedUpdateWithoutExperiencesInputObjectSchema = Schema;
