...
const Schema: z.ZodType<Prisma.ExperienceUncheckedUpdateManyWithoutResumeNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ExperienceUncheckedUpdateManyWithoutResumeNestedInputObjectSchema =
  Schema;
