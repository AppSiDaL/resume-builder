...
const Schema: z.ZodType<Prisma.SkillUncheckedUpdateManyWithoutResumeNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => SkillUpsertWithWhereUniqueWithoutResumeInputObjectSchema,
          ),
          z
            .lazy(
              () => SkillUpsertWithWhereUniqueWithoutResumeInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => SkillUpdateWithWhereUniqueWithoutResumeInputObjectSchema,
          ),
          z
            .lazy(
              () => SkillUpdateWithWhereUniqueWithoutResumeInputObjectSchema,
...
export const SkillUncheckedUpdateManyWithoutResumeNestedInputObjectSchema =
  Schema;
