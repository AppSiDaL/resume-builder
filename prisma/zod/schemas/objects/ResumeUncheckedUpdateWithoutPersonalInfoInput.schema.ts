...
const Schema: z.ZodType<Prisma.ResumeUncheckedUpdateWithoutPersonalInfoInput> =
  z
    .object({
      id: z
        .union([
      ...
      skills: z
        .lazy(
          () => SkillUncheckedUpdateManyWithoutResumeNestedInputObjectSchema,
        )
        .optional(),
      certifications: z
        .lazy(
...
export const ResumeUncheckedUpdateWithoutPersonalInfoInputObjectSchema = Schema;
