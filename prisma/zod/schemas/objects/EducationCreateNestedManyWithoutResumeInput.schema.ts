...
const Schema: z.ZodType<Prisma.EducationCreateNestedManyWithoutResumeInput> = z
  .object({
    create: z
      .union([
...
export const EducationCreateNestedManyWithoutResumeInputObjectSchema = Schema;
