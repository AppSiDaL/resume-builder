...
const Schema: z.ZodType<Prisma.ExperienceUncheckedCreateNestedManyWithoutResumeInput> =
  z
    .object({
      create: z
        .union([
...
export const ExperienceUncheckedCreateNestedManyWithoutResumeInputObjectSchema =
  Schema;
