...
const Schema: z.ZodType<Prisma.ProjectUpdateManyWithWhereWithoutResumeInput> = z
  .object({
...
export const ProjectUpdateManyWithWhereWithoutResumeInputObjectSchema = Schema;
