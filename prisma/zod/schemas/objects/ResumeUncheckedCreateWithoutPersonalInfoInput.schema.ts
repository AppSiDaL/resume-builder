...
const Schema: z.ZodType<Prisma.ResumeUncheckedCreateWithoutPersonalInfoInput> =
  z
    .object({
...
export const ResumeUncheckedCreateWithoutPersonalInfoInputObjectSchema = Schema;
