...
const Schema: z.ZodType<Prisma.PersonalInfoUncheckedUpdateOneWithoutResumeNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const PersonalInfoUncheckedUpdateOneWithoutResumeNestedInputObjectSchema =
  Schema;
