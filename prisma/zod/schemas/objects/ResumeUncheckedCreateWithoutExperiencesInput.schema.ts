...
const Schema: z.ZodType<Prisma.ResumeUncheckedCreateWithoutExperiencesInput> = z
  .object({
...
export const ResumeUncheckedCreateWithoutExperiencesInputObjectSchema = Schema;
