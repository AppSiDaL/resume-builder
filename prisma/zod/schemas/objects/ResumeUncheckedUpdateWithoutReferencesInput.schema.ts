...
const Schema: z.ZodType<Prisma.ResumeUncheckedUpdateWithoutReferencesInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const ResumeUncheckedUpdateWithoutReferencesInputObjectSchema = Schema;
