...
export const ResumeAggregateSchema = z.object({
  orderBy: z
    .union([
  ...
  _count: z
    .union([z.literal(true), ResumeCountAggregateInputObjectSchema])
    .optional(),
  _min: ResumeMinAggregateInputObjectSchema.optional(),
